menu(mode="multiple" title='&Develop' sep=sep.bottom image=\uE26E)
{
	menu(mode="single" title='editors' image=\uE17A)
	{
		...
		separator
		item(title='PHP Storm' image='C:\Program Files (x86)\JetBrains\PhpStorm 2023.1\bin\phpstorm.ico' cmd='phpstorm64' 			args='"@sel.path"')
		separator
		item(title='Notepad ++' image='C:\Program Files\Notepad++\notepad++.png' args='"@sel.path"')
		separator
		item(title='Notepad' image='C:\Program Files\Notepad++\notepad++.png' cmd='notepad' args='"@sel.path"')
	}
